  ...
  "inline-flex items-center justify-center gap-2 rounded-[calc(var(--radius)-0.28rem)] text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-white/75 text-[var(--foreground)] shadow-[var(--shadow-sm)] hover:-translate-y-0.5 hover:bg-white hover:shadow-[var(--shadow-md)] dark:bg-[rgba(255,255,255,0.08)] dark:text-[var(--foreground)] dark:hover:bg-[rgba(255,255,255,0.14)]",
